...
public class WrappedJid implements com.glaciersecurity.glaciermessenger.xmpp.Jid {
    ...
    @Override
    public com.glaciersecurity.glaciermessenger.xmpp.Jid asBareJid() {
        return new WrappedJid(inner.asBareJid());
    }

    @Override
    public com.glaciersecurity.glaciermessenger.xmpp.Jid withResource(CharSequence resource) {
    ...
    @Override
    public com.glaciersecurity.glaciermessenger.xmpp.Jid getDomain() {
    ...
    @Override
    public int compareTo(com.glaciersecurity.glaciermessenger.xmpp.Jid jid) {
