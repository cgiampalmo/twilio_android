package com.glaciersecurity.glaciermessenger.ui.service;
...
import com.glaciersecurity.glaciermessenger.services.MediaPlayer;
...
import com.glaciersecurity.glaciermessenger.utils.WeakReferenceSet;
...
public class AudioPlayer implements View.OnClickListener, MediaPlayer.OnCompletionListener, SeekBar.OnSeekBarChangeListener, Runnable, SensorEventListener {
	...
	private boolean init(ViewHolder viewHolder, Message message) {
		...
		ColorStateList color = ContextCompat.getColorStateList(messageAdapter.getContext(), viewHolder.darkBackground ? R.color.white70 : R.color.green_685);
