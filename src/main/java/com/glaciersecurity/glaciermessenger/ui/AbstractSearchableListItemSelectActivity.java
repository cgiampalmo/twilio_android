...
import com.glaciersecurity.glaciermessenger.ui.adapter.ListItemSelectAdapter;

import java.util.ArrayList;
import java.util.List;

public abstract class AbstractSearchableListItemSelectActivity extends XmppActivity implements TextView.OnEditorActionListener {
	...
	public void onCreate(final Bundle savedInstanceState) {
		...
		mListItemsAdapter = new ListItemSelectAdapter(this, listItems);
