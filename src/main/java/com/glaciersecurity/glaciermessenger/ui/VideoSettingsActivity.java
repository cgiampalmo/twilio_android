...
public class VideoSettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        VideoSettingsFragment videoSettingsFragment = VideoSettingsFragment.newInstance(sharedPreferences);
        getSupportFragmentManager()
                .beginTransaction()
                .replace(android.R.id.content, videoSettingsFragment)
                .commit();
    }
    ...
    public static class VideoSettingsFragment extends PreferenceFragmentCompat {
        ...
        public static VideoSettingsFragment newInstance(SharedPreferences sharedPreferences) {
            VideoSettingsFragment videoSettingsFragment = new VideoSettingsFragment();
            videoSettingsFragment.sharedPreferences = sharedPreferences;
