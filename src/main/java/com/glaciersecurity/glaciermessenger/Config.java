...
public final class Config {
	...
	//CMG cognito bypass org
	public static final String TESTER_ORG = "test";
	...
	public static final int PING_MIN_INTERVAL = 15; //AM-344 change from 30
	...
	public static final long OMEMO_AUTO_EXPIRY = 45 * MILLISECONDS_IN_DAY; //7 * MILLISECONDS_IN_DAY; //ALF AM-286
